								...
								<div class="col-lg-5 col-md-6 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group-prepend">
											...
											<input type="text" class="login-input form-control p-3" name="signupFirstName" id="signupFirstName" placeholder="Enter First Name">
										</div>
									</div>
								</div>
								<div class="col-lg-5 col-md-6 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group-prepend">
											...
											<input type="text" class="login-input form-control p-3" name="signupMiddleName" id="signupMiddleName" placeholder="Enter Middle Name">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-5 col-md-6 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group-prepend">
											...
											<input type="text" class="login-input form-control p-3" name="signupLastName" id="signupLastName" placeholder="Enter Last Name">
										</div>
									</div>
								</div>
								<div class="col-lg-5 col-md-6 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group-prepend">
											...
											<input type="text" class="login-input form-control p-3" name="signupSuffix" id="signupSuffix" placeholder="Enter Suffix">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-10 col-md-12 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group-prepend">
											...
											<input type="text" class="login-input form-control p-3" pattern=".{6,15}" name="signupUsername" id="signupUsername" placeholder="Enter Username">
										</div>
								...
								<div class="col-lg-10 col-md-12 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group-prepend">
											...
											<input type="password" class="login-input form-control p-3" pattern=".{6,15}" name="signupPassword" id="signupPassword" placeholder="Enter Password">
										</div>
										<p><small>Please use 6 to 15 characters.</small></p>
									</div>
								</div>
								...
								<div class="col-lg-10 col-md-12 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group-prepend">
											...
											<input type="password" class="login-input form-control p-3" pattern=".{6,15}" name="signupConfirmPassword" id="signupConfirmPassword" placeholder="Please Confirm Password">
										</div>
										<p><small>Please use 6 to 15 characters.</small></p>
									</div>
								</div>
					...
					<div class="row justify-content-center mt-5">
						<div class="col-md-8">
							<div class="form-group text-center">
								<p class="lead">Already a member? <a class="lead text-info" href="login.php">Login Here!</a></p>
