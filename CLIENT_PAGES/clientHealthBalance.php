...
<body style="background-color: #fcecdc;">
  ...
  <div class="client-health-cashin">
          ...
          <div class="client-header client-header-left" style="background-color: #bacccc;">
            <div class="row text-center d-flex align-items-center">
              ...
              <div class="col-lg-9 d-flex align-items-center">
                <h2 style="font-size: 2.6vw; font-weight: 500;">HEALTH BALANCE</h2>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="client-education-cashin-text">
              <div class="row">
                ...
                <div class="col-lg-7 p-0">
                  <input type="text" required name="healthtotalbalance" id="loginUsername" placeholder="<?php echo $Balance;?>" value="<?php echo $Balance;?>">
                </div>
              </div>
            </div>
            <div class="client-education-cashin-text">
              <div class="row">
                ...
                <div class="col-lg-7 p-0">
                  <input type="text" required name="healthcashinbalance" id="loginPassword" placeholder="<?php if($Balance<=0){echo 'Account Inactive';}else{ echo 'CASH IN';}?>"  <?php if($Balance<=0){echo 'disabled';}?>>
                </div>
              </div>
            </div>
