    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-md-center">
            ...
            <div class="col-sm-4">
                <div class="title text-center">
                    <a href="#">
                        <h1 class="title"><img src="../DESIGN_EXTENSIONS\img\family.jpg"><br>EDUCATION BALANCE</h1>
                    </a>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="title text-center">
                    <a href="#">
                        <h1 class="title"><img src="../DESIGN_EXTENSIONS\img\family.jpg"><br>HEALTH BALANCE</h1>
                    </a>
                </div>
            </div>
