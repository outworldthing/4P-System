						...
						<div class="col-lg-6 col-md-6 col-sm-12 ">
							<div class="card ml-auto mr-auto pt-5" style="width: 18rem; height: 25rem;">
								...
								<div class="card-body text-center">
									...
									<a href="teacherAttendanceReport.php" class="btn btn-primary stretched-link">Enter</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="card ml-auto mr-auto pt-5" style="width: 18rem; height: 25rem;">
								...
								<div class="card-body text-center">
									...
									<a href="teacherHandledSections.php" class="btn btn-primary stretched-link">Enter</a>
								</div>
							</div>
						</div>
					</div>
