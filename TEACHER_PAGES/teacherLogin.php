...
<body style="background-color:#e3eef2;">
  <div class="teacher-login" style="height: 100vh;">
    <div class="container-fluid">
          ...
          <div class="client-header client-header-left" style="background-color:#adcdd8">
            <div class="row text-center d-flex align-items-center">
              ...
              <div class="col-lg-9 d-flex align-items-center">
                <h2 style="font-size: 3.6vw;">TEACHER LOG-IN</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="teacher-login-body-left text-center ">
            <h2>NOT A MEMBER YET?</h2>
            <a href="teachersignup.php">REGISTER NOW</a>
          </div>
        </div>

        <div class="col-lg-7">
          <div class="teacher-login-head teacher-login-head-right">
            <div class="teacher-login-input">
              <div class="row">
                <div class="col-lg-12">
                  <form method="POST" action="teacherPortal.php" class="form" name="signupForm" id="signupForm" onsubmit="return validateForm();">
                    ...
                    <div class="teacher-login-buttons">
                      <div class="row">
                        <div class="col-lg-6 text-right">
                          <input type="submit" name="" value="LOGIN" id="signupSubmit" class="teacher-login-button">
                        </div>
                  </form>
                  <div class="col-lg-6">
                    <form action="../index.php">
                      <input type="submit" name="" value="BACK" class="teacher-login-button">
                    </form>
                  </div>
                </div>
              </div>
