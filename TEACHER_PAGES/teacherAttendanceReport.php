                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number" class="form-input form-control p-3" name="attendanceAbsences" id="attendanceAbsences" pattern="^[0-9]+$" placeholder="Total Absences">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number" class="form-input form-control p-3" name="attendanceSchoolDays" id="attendanceSchoolDays" pattern="^[0-9]+$" placeholder="Total School Days">
                                        </div>
                                    </div>
                                </div>
                            </div>
