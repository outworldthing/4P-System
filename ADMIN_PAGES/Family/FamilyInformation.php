      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Family Information</a>
          </div>
              ...
              <div class="card card-profile">
                ...
                <div class="card-body">
                  ...
                  <form>
					...
					<button type="submit" class="btn btn-primary pull-center">View Info</button>
			...
			<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Family Information Table</h4>
                </div>
                <div class="card-body">
