...
<html lang="en">
    ...
    $male = "";
    $female = "";
    $result = $ADMIN->getPersonalInformation($FirstName, $MiddleName, $LastName, $Suffix);
                        ...
                        <ul class="nav">
                            <li class="nav">
                                <form action="SearchFamily.php" method="POST">
                                    ...
                                    <button type="submit">Family Basic Information</button>
                                </form>
                            </li>
                            <li class="nav-item active ">
                                <form action="SearchForEdit.php" method="POST">
                                    ...
                                    <input type="hidden" name="loginPassword" value="<?php echo $password; ?>" />
                                    <i class="material-icons">content_paste</i>
                                    <button type="submit">Family Edit Information</button>
                                </form>
                            </li>
                            <li class="nav-item ">
                                <form action="SearchFamilyLogs.php" method="POST">
                                    ...
                                    <input type="hidden" name="loginPassword" value="<?php echo $password; ?>" />
                                    <i class="material-icons">content_paste</i>
                                    <button type="submit">Family Logs</button>
                                </form>
                            </li>
                        </ul>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                <a class="navbar-brand" href="javascript:;">Family Edit Basic Information</a>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-primary">
                                                <h4 class="card-title" style='text-align:center'>Edit Personal Information</h4>
                                            </div>
                                            <br>
                                            <div class="card-body">
                                                <form action="../../ADMIN_PROCESSES/FamilyInformationProcess.php">
                                                    <input type="hidden" name="loginUsername" value="<?php echo $username; ?>" />
                                                    <input type="hidden" name="loginPassword" value="<?php echo $password; ?>" />
                                                    <input type="hidden" name="FamilyID" value="<?php $rows['FamilyID']; ?>" />
                                                    <input type="hidden" name="MemberID" value="<?php $rows['MemberID']; ?>" />
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">First Name</label>
                                                                <input type="text" name="FirstName" value="<?php $rows['FirstName'] ?>" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Middle Name</label>
                                                                <input type="text" name="MiddleName" value="<?php $rows['MiddleName'] ?>"class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Last Name</label>
                                                                <input type="text" name="LastName" value="<?php $rows['LastName'] ?>"class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Suffix (optional)</label>
                                                                <input type="text" name="Suffix" value="<?php $rows['Suffix'] ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <p>Birth Date</p>
                                                                <input type="date" value="<?php $rows['BirthDate'] ?>" name="BirthDate" value="yyyy-mm-dd" class="form-control" placeholder="Birth Date" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                        ...
                                        <div class="card-body">
                                            <form action="../../ADMIN_PROCESSES/FamilyInformationProcess.php">
                                                ...
                                                while ($rows = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    ?>
                                                    <input type="hidden" name="FamilyID" value="<?php echo $rows['FamilyID']; ?>" />
                                                    <input type="hidden" name="MemberID" value="<?php echo $rows['MemberID']; ?>" />
                                                    <div class = "row">
                                                        <div class = "col-md-6">
                                                            <div class = "form-group">
                                                                <label class = "bmd-label-floating">First Name</label>
                                                                <input type = "text" name = "FirstName" value = "<?php echo $rows['FirstName']; ?>" class = "form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class = "col-md-6">
                                                            <div class = "form-group">
                                                                <label class = "bmd-label-floating">Middle Name</label>
                                                                <input type = "text" name = "MiddleName" value = "<?php echo $rows['MiddleName']; ?>"class = "form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class = "col-md-6">
                                                            <div class = "form-group">
                                                                <label class = "bmd-label-floating">Last Name</label>
                                                                <input type = "text" name = "LastName" value = "<?php echo $rows['LastName']; ?>"class = "form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class = "col-md-4">
                                                            <div class = "form-group">
                                                                <label class = "bmd-label-floating">Suffix (optional)</label>
                                                                <input type = "text" name = "Suffix" value = "<?php echo $rows['Suffix']; ?>" class = "form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class = "row">
                                                        <div class = "col-md-6">
                                                            <div class = "form-group">
                                                                <p>Birth Date</p>
                                                                <input type = "date" value = "<?php echo $rows['BirthDate']; ?>" name = "BirthDate" value = "yyyy-mm-dd" class = "form-control" placeholder = "Birth Date" required>
                                                            </div>
                                                        </div>
                                                        <div class = "col-md-6">
                                                            <div class = "form-group">
