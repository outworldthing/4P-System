  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav">
            <a class="nav-link" href="SearchFamily.html">
              <i class="material-icons">content_paste</i>
              <p>Search Family</p>
            </a>
          </li>
          <li class="nav-item active ">
            <a class="nav-link" href="SearchForEdit.html">
              <i class="material-icons">content_paste</i>
              <p>Edit Family</p>
            </a>
          </li>
		  <li class="nav-item ">
            <a class="nav-link" href="FamilyInformation.html">
              <i class="material-icons">content_paste</i>
              <p>family Information</p>
            </a>
          </li>
		  <li class="nav-item ">
            <a class="nav-link" href="SearchFamilyLogs.html">
              <i class="material-icons">content_paste</i>
              <p>Search Family Logs</p>
            </a>
          </li>
		  <li class="nav-item ">
            <a class="nav-link" href="FamilyBasicInfo.html">
              <i class="material-icons">content_paste</i>
              <p>View Family Basic Info</p>
            </a>
          </li>
		  <li class="nav-item ">
            <a class="nav-link" href="FamilyLogs.html">
              <i class="material-icons">content_paste</i>
              <p>Family Logs</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Edit Family Information</a>
          </div>
        ...
        <div class="container-fluid">
		  ...
		  <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  <h4 class="card-title">Edit Family Information</h4>     
					<br>
                  <form>
                    <div class="row">       
                      <div class="col">
						...
						<br>
							...
							<div style='text-align:center'>
								<label class="bmd-label-floating">Suffix (if any)</label>
								<input type="text" class="form-control">
							</div>
					...
					<br>
					<button type="submit" class="btn btn-primary pull-center">Search</button>
					<button type="submit" class="btn btn-primary pull-center">Edit Info</button>
			...
			<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Edit Family Information Table</h4>
                </div>
                <div class="card-body">
