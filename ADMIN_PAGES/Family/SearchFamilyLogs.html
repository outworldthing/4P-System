      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Search Family Logs</a>
          </div>
        ...
        <div class="container-fluid">
		  ...
		  <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  <h4 class="card-title">Search Family Logs</h4>     
					<br>
                  <form>
                    <div class="row">       
                      <div class="col">
					...
					<br>
					<button type="submit" class="btn btn-primary pull-center">Search Logs</button>
			...
			<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Search Family Logs Table</h4>
                </div>
                <div class="card-body">
